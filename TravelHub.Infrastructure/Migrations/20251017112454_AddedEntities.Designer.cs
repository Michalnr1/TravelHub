...
namespace TravelHub.Infrastructure.Migrations
{
    ...
    [Migration("20251017112454_AddedEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelHub.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TravelHub.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TravelHub.Domain.Entities.Accommodation", b =>
                {
                    b.HasOne("TravelHub.Domain.Entities.Spot", "Spot")
                        ...
                        .HasForeignKey("TravelHub.Domain.Entities.Accommodation", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TravelHub.Domain.Entities.Expense", b =>
                {
                    ...
                    b.HasOne("TravelHub.Domain.Entities.Currency", "Currency")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("TravelHub.Domain.Entities.Spot", b =>
                {
                    b.HasOne("TravelHub.Domain.Entities.Activity", "Activity")
                        .WithMany("Spots")
