...
namespace TravelHub.Infrastructure.Migrations
{
    ...
    [Migration("20251107115924_AddedTransferConnectionToExpense")]
    partial class AddedTransferConnectionToExpense
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CountrySpot", b =>
                {
                    ...
                    b.HasKey("SpotsId", "CountriesCode", "CountriesName");

                    b.HasIndex("CountriesCode", "CountriesName");

                    b.ToTable("SpotCountries", (string)null);
                });
            ...
            modelBuilder.Entity("CountrySpot", b =>
                {
                    b.HasOne("TravelHub.Domain.Entities.Spot", null)
                        .WithMany()
