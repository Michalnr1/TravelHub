        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrencyKey = table.Column<string>(type: "nvarchar(3)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonFriends", x => new { x.FriendOfId, x.FriendsId });
                    table.ForeignKey(
                        name: "FK_PersonFriends_Persons_FriendOfId",
                        column: x => x.FriendOfId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonFriends_Persons_FriendsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trips_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExpensesToCoverId = table.Column<int>(type: "int", nullable: false),
                    ParticipantsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseParticipants", x => new { x.ExpensesToCoverId, x.ParticipantsId });
                    table.ForeignKey(
                        name: "FK_ExpenseParticipants_Expenses_ExpensesToCoverId",
                        column: x => x.ExpensesToCoverId,
                        principalTable: "Expenses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpenseParticipants_Persons_ParticipantsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Duration = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    TripId = table.Column<int>(type: "int", nullable: false),
                    FromSpotId = table.Column<int>(type: "int", nullable: false),
                    ToSpotId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonFriends_FriendsId",
                table: "PersonFriends",
                column: "FriendsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transports_FromSpotId",
                table: "Transports",
                column: "FromSpotId");

            migrationBuilder.CreateIndex(
                name: "IX_Transports_ToSpotId",
                table: "Transports",
                column: "ToSpotId");
