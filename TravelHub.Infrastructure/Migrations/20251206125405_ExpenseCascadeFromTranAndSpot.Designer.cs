...
namespace TravelHub.Infrastructure.Migrations
{
    ...
    [Migration("20251206125405_ExpenseCascadeFromTranAndSpot")]
    partial class ExpenseCascadeFromTranAndSpot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelHub.Domain.Entities.FlightInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FlightNumbers")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("TripId", "DepartureTime");
            ...
            modelBuilder.Entity("TravelHub.Domain.Entities.FlightInfo", b =>
                {
                    b.HasOne("TravelHub.Domain.Entities.Person", "AddedBy")
