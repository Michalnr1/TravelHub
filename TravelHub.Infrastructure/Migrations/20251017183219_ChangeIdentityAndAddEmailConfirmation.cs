...
{
    /// <inheritdoc />
    public partial class ChangeIdentityAndAddEmailConfirmation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonFriends", x => new { x.UserId, x.FriendId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonFriends_FriendId",
                table: "PersonFriends",
                column: "FriendId");
