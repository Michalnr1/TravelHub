...
public class AddedPrivacyToAccountMigrationTests
{
    private readonly Assembly _migrationsAssembly;

    public AddedPrivacyToAccountMigrationTests()
    {
    ...
    private object CreateMigrationInstance()
    {
        var migrationType = _migrationsAssembly.GetTypes()
            .FirstOrDefault(t => t.Name == "AddedPrivacyToAccount");

        if (migrationType == null)
        {
            throw new InvalidOperationException("AddedPrivacyToAccount migration type not found");
        }
